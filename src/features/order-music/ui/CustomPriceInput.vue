<template>
	<div class="flex flex-col w-full gap-1">
		...
		<input
			...
			class="bg-transparent text-5xl focus:border-[#ADFF00] block w-full rounded-md p-3 text-[#FFFFFF4D]"
			:class="{ 'border-[#ADFF00] border-1 border-solid': props?.priceChangeAllowed, 'border-0': !props?.priceChangeAllowed }"
			:disabled="disabled"
			@blur="formatPrice"
			@input="updateValue"
		>
