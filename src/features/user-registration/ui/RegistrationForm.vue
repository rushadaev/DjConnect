	...
	<div class="bg-black text-white min-h-screen p-4 flex flex-col">
		...
		>
			...
			<VInput
				...
				content-message="Номер карты на выплаты"
...
// import localization from './RegistrationForm.localization.json'
