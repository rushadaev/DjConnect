<template>
	<div class="relative">
		<div
			class="cursor-pointer hover:opacity-80 bg-[#fff8f8] inline-flex w-full items-center justify-center gap-4 rounded px-4 text-sm leading-none h-10 text-black shadow focus:shadow-outline outline-none"
		...
		<transition name="slide-fade">
			<div
				v-if="toggleState"
				class="absolute left-0 right-0 rounded mt-1 z-10"
			>
				<div class="py-2">
					<div class="max-h-[200px] overflow-y-auto shadow-lg backdrop-blur-[10px]">
						<div
							...
							:key="index"
							class="text-sm leading-none hover:opacity-70 text-white rounded border border-black mb-1 bg-lightGrey flex items-center px-3 py-5 relative cursor-pointer hover:bg-green-200"
